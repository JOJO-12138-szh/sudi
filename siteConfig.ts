...
export const siteConfig = {
  // 1. 网站标题与博主信息
  title: "粟祖杭 の 个人网站",
  faviconUrl: "https://img.cdn1.vip/i/6a7ed85ed313f_1786697822.webp",
  authorName: "粟祖杭",
  bio: "你好，我是 粟祖杭，一名专注于 C/C++ 嵌入式开发 的学习者与实践者。",
  ...
  avatarUrl: "https://img.cdn1.vip/i/6a7ed85ed313f_1786697822.webp",
...
// 修改这里：变成图片数组
  ...
  social: {
    github: "https://github.com/JOJO-12138-szh",
    gitee: "",
    google: "",
    email: "1694989419@qq.com",
    qq: "1694989419",
    wechat: "",
  },
  counts: {
  ...
  // 👇 【新增】：全局背景弹幕配置
  danmakuList: ["在干嘛呢？", "有笨蛋嘛？", "MD 模拟什么时候才能出图啊", "BUG 修复进度 99%", "今天背单词了吗？", "写算法中", "到底在干嘛？"],
  gitalkConfig: {
    clientID: "",
    clientSecret: "",
    repo: "",
  ...
  buildDate: "2026-08-10T12:30:00", // 建站日期
